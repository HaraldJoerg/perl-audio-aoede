...

{
    ...
    my $voice =  Audio::Aoede::Voice->new(
        ...
        envelope_function => envelope(0,0,1,$release)
    );
    $voice->add_notes($track,$rate,240);
...

{
    ...
    my $voice =  Audio::Aoede::Voice->new(
        function          => $A->square_wave(),
        envelope_function => envelope(20,0,1,$release)
    );
    $voice->add_notes($track,$rate,240);
    is ($voice->samples->dim(0),$rate,
...

{
    ...
    my $voice =  Audio::Aoede::Voice->new(
        function          => $A->square_wave(),
        envelope_function => envelope(0,20,0,$release)
    );
    $voice->add_notes($track,$rate,240);
    is ($voice->samples->dim(0),$rate,
